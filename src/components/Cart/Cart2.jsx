...
export default function Cart2() {
  ...
  useEffect(() => {
    if (isAuthenticated && !companyProfile) {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row pt-10 lg:pt-10 max-w-7xl px-4 mx-auto">
                    ...
                    {shipping > 0 &&
                      ...
                      companyProfile?.shipping && (
                        <div className="text-sm text-green-500 italic">
                          Add ₹
                          {(
                            companyProfile.shipping.minAmount - subtotal
                          ).toFixed(2)}{" "}
                    ...
                    {!couponsLoading && availableCoupons.length > 0 && (
                      <div className="mb-4 space-y-1">
                        ...
                        <div className="px-2 mt-2">
                          <div className="flex w-full overflow-hidden rounded-md border border-gray-300 bg-white">
                            <input
                              type="text"
                              value={couponInput}
                              onChange={(e) => setCouponInput(e.target.value)}
                              placeholder="Enter coupon code"
                              className="w-0 flex-grow max-w-[160px] px-2 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
                            />
                            <button
                              className="bg-green-600 hover:bg-green-700 disabled:bg-gray-400 disabled:cursor-not-allowed text-white px-4 py-2 font-medium text-sm transition-colors duration-200 flex items-center justify-center"
